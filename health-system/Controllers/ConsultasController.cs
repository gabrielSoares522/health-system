...
namespace health_system.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        {
            var context = _context.Consultas.Include(c => c.Medico).Include(c => c.Paciente);
        ...
        public async Task<IActionResult> Create([Bind("Id,diaConsulta,PacienteId,MedicoId")] Consulta consulta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,diaConsulta,PacienteId,MedicoId")] Consulta consulta)
        {
            if (id != consulta.Id)
            {
                return NotFound();
