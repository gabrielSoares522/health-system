...
namespace health_system.Controllers
{
    public class RemediosController : Controller
    {
        ...
        {
            var context = _context.Remedios.Include(r => r.Medida);
        ...
        {
            ViewData["MedidaId"] = new SelectList(_context.Ingestoes, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,MedidaId")] Remedio remedio)
        {
            ...
            ViewData["MedidaId"] = new SelectList(_context.Ingestoes, "Id", "Id", remedio.MedidaId);
            return View(remedio);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,MedidaId")] Remedio remedio)
        {
            if (id != remedio.Id)
            {
                return NotFound();
